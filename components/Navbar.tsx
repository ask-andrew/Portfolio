    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="#top" className="flex items-center space-x-3 group">
          <div className="w-8 h-8 bg-blue-600 rounded-sm rotate-45 flex items-center justify-center group-hover:bg-blue-500 transition-colors shrink-0">
            <span className="text-white font-bold text-xs -rotate-45">AL</span>
          </div>
          <span className="font-black text-2xl tracking-tighter text-white group-hover:text-blue-400 transition-colors">AskAndrew</span>
        </a>
